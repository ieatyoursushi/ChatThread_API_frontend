...
const textToggler = new TextToggler(
    ...
    ".textToggle",
    true,
    `${string1} Freakstagram, by Freakbook Inc. You can think of it as an anonymous residence hall chat app that is currently in its testing stages. Enjoy! (We apologize for any inconveniences with the app) <span class='textToggle'> <u>read less</u> </span>`,
